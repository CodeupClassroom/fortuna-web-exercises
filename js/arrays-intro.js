...
var shapes = ['triangle', 'rectangle', 'circle', 'square'];
// console.log(shapes);
...
var favoriteFoods = ['pizza', 'pasta', 'tacos'];
...
// can save many lines of code by iterating through an item, rather than checking every single element
// can iterate completely through an array without knowing its length
...
//     } else { // it's not an instructor we know
//         alert("I don't know " + instructors[i]);
...
shapes.forEach(function(thingamabob) {

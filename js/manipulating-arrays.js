"use strict";
// NOTE: we did not complete this walkthrough, but if you'd like to practice it on your own to build your skills, feel free to do so!
(function () {
    ...
    cheeses.push("Red Windsor");
    // console.log(cheeses);

    // Simplify console logging later in the code
    ...
    // cheeses.push("Nacho","Ragstone","Havarti");
    // cheeses.push("Nacho");
